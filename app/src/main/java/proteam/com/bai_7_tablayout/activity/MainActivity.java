...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btnSimpleTabsNoViewPager, btnSimpleTabs, btnScrollableTabs, btnIconTextTabs, btnIconTabs, btnCustomIconTextTabs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSimpleTabsNoViewPager = (Button) findViewById(R.id.btnSimpleTabsNoViewPager);
        ...
        btnSimpleTabsNoViewPager.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnSimpleTabsNoViewPager:
                startActivity(new Intent(MainActivity.this, SimpleTabsNonViewPagerActivity.class));
                break;
            case R.id.btnSimpleTabs:
                startActivity(new Intent(MainActivity.this, SimpleTabsViewPagerActivity.class));
                break;
